...
<button class="default-btn"> <i class='bx bx-paper-plane'></i>View Pricing & Features</button></NuxtLink>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="new-app-main-banner-wrap-image" data-aos="fade-left" data-aos-duration="2000">
                        <img src="../../assets/images/cpq-integration/cpq-integration-banner.png" alt="'Salesforce CPQ Integration', 'CPQ Integration for Midsize business', 'Best CPQ Integrations with HubSpot CRM', 'hubspot cpq integration', Enterprise CPQ Integration', 'Microsoft Dynamics 365 CPQ Integration', 'CPQ Integration work', 'Easy CPQ Integration', 'CPQ integration with Salesforce', 'hubspot', 'sugarcrm', 'freshworks', 'micro dynmaics 365','cpq-integration'">
                    </div>
                </div>
            </div>
        </div>
