          ...
          <div class="card_sec">
            <div class="main_card_div">
              <div class="innersection">
                ...
                <div class="content">
                  <div class="card-content">
                    <div class="card-info">Tailored for large enterprises with complex pricing and estimation needs.
                    </div>
                  </div>
                </div>
                <div class="usd_usdclass">
          ...
          <div class="card_sec">
            <div class="main_card_div">
              <div class="innersection">
                ...
                <div class="content">
                  <div class="card-content">
                    <div class="card-info">CRM integration with streamlined quotes and approvals for growing businesses.
                    </div>
                  </div>
                </div>
                <div class="usd_usdclass">
        ...
        <table class="centered-table1">
          <thead role="rowgroup">
            <tr class="table_row1" role="row">
              ...
              <th v-for="(data, index) in editions" :key="index" role="columnheader" scope="col" class="table__cell2">
                  ...
                  <div class="edition__copy__wrapper">
                    ...
                    <div class="price_wrapper default" :data-currency="data.currency">
                      <div class="edition_price">
                        <span class="price_text__symbol">{{ data.currency_symbol }}</span>
