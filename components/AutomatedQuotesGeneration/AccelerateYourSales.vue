            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="about-content">
                        <h3>Accelerate Your Sales Success: Create Quotes using DealDox Automation Software at 10x Speed
                        </h3>
                        <p>Optimize quote generation speed by leveraging our Quoting software to automate your sales
                            ...
                            captures the scope, assumptions, price, and client needs. Our <NuxtLink to="/quoting-software">automated quoting software</NuxtLink> covers
