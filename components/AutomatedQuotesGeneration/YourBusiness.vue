                ...
                <div class="col-lg-12 col-md-12">
                    <div class="features-item-mid-content-senction bg-white with-border">
                        ...
                        <p>Effortlessly adapt to global pricing requirements with DealDox CPQ: Switch between price listings
                            ...
                            switch and select your preferred currency with ease.</p>
                        <p>Empower your sales process by easily generating custom quotes in any desired language with DD
                            quotation software. </p>
                    </div>
                </div>
            </div>
        </div>
