            ...
            <div class="row justify-content-center pt-500">
                <div class="col-xl-3 col-lg-6 col-sm-6 col-md-6">
                    <div class="single-features-item">
                        <div class="icon">
                            <img src="../../assets/images/Hubspot/Swift Quote.png" alt="image">
                        </div>
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 col-md-6">
                    <div class="single-features-item">
                        <div class="icon">
                            <img src="../../assets/images/Hubspot/Quick Approvals.png" alt="image">
                        </div>
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 col-md-6">
                    <div class="single-features-item">
                        <div class="icon">
                            <img src="../../assets/images/Hubspot/Configure Price Quote.png" alt="image">
                            </div>                        
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 col-md-6">
                    <div class="single-features-item">
                        <div class="icon">
                            <img src="../../assets/images/Hubspot/Subscription.png" alt="image">
                        </div>
