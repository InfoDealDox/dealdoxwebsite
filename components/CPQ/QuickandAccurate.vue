            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="about-content">
                        ...
                        <p>
                        A predetermined questionnaire flow, facilitated by the best CPQ tools, guides the sales team in configuring the ideal product. This process automatically prompts upgrade, upsell, 
                        and cross-selling recommendations to enhance deal size. 
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="about-content">
                        ...
                        <p>
                        With the best CPQ tools, you can effortlessly generate quotes for an extensive range of managed services, spanning help desk support, hosting, security monitoring, and more. Custom pricing structures to include vital specifics like contract duration, target margin, 
                        discounts, setup and exit fees, user counts, and more. 
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12">
                    <div class="about-content-right">
                        ...
                        <p>
                          Best CPQ tools automate quoting with versatility. Handle fixed, tiered, or pay-per-usage pricing, manage discounts, update prices, 
                          and adapt contracts with ease. Add-ons enhance flexibility and scalability.   
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="about-content">
                        ...
                        <p>We offer everything as a service where you can add services, subscriptions, and items from our
                            catalogue in a quote. With the best CPQ  software sales automation you can get quotes for all of your services at
