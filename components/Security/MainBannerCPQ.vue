            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12">
                    <div class="new-app-main-banner-wrap-content">
                        <h1> <span class="sub-title">Data and Privacy Protection</span>
                        </h1>
                        <p>Our Commitment to Your Security and Trust 
                        </p>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12">
                    <div class="new-app-main-banner-wrap-image" data-aos="fade-left" data-aos-duration="2000">
                        <img src="../../assets/images/cpq/DataPrivacy.png" alt="image">
                    </div>
                </div>
            </div>
        </div>
