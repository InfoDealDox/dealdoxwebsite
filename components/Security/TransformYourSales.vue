    ...
    <div class="key-features-area bg-#FAFAFA pt-100 pb-75">
        <div class="container">
            <div class="section-title title-with-bg-text">
                <h2>Security Guardrails: Protecting Your Data and Privacy </h2>
            </div>
            ...
            <div class="section-title title-with-bg-text">
            <h4>How can I report a security or privacy issue?</h4>
            <p>In case you have come across a security or privacy issue, kindly report it to us by sending an email to info@dealdox.io </p>
            </div>
        </div>
    </div>
</template>
