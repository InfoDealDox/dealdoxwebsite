                    ...
                    <div class="features-item with-border">
                        <div class="about-img">
                            <img src="../../assets/images/MicrosoftDynamic/Close Deals Faster with DealDox.png"
                                data-aos="fade-up" alt="Dynamics 365 CRM">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12">
                    ...
                    <div class="features-item with-border">
                        <div class="about-img">
                            <img src="../../assets/images/MicrosoftDynamic/Generate Lightning-fast Professional Quotes.png"
                                data-aos="fade-up" alt="Generate Lightning-fast Professional Quotes">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="features-item with-border">
                        <div class="about-img">
                            <img src="../../assets/images/MicrosoftDynamic/Utilize the Power of a User-Friendly CPQ Solution.png"
                                data-aos="fade-up" alt="automated workflows">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12">
                    <div class="about-content">
                        ...
                        <p>Your operations staff may easily change the pricing, processes, and other features with DealDox's
                            ...
                            are always ready to answer your concerns and assist you.</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="about-content">
                            ...
                            <p>With DealDox, collaboration becomes effortless as every internal team member and buyer can
                                seamlessly connect and contribute to one centralized digital location.</p>
                        </div>
                    </div>
                </div>
