            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12">
                    <div class="new-app-main-banner-wrap-content">
                        <h1>DealDox and<br><span class="sub-title">Salesforce CRM</span></h1>
                        <p>Maximize Your CRM Potential with DealDox CPQ
                        </p>
                        <div class="tb-30">
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="new-app-main-banner-wrap-image" data-aos="fade-left" data-aos-duration="2000">
                        <img src="../../assets/images/Salesforce/DealDox and Salesforce CRM.png"
                            alt="Dealdox Cpq with CRM">
                    </div>
                </div>
            </div>
        </div>
