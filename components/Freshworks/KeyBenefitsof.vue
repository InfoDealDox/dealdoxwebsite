            ...
            <div class="row justify-content-center pt-500">
                <div class="col-xl-3 col-lg-6 col-sm-6 col-md-6">
                    <div class="single-features-item">
                        <div class="icon">
                            <img src="../../assets/images/Freshwork/Swift Quote.png" alt="Swift Quote">
                        </div>
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 col-md-6">
                    <div class="single-features-item">
                        <div class="icon">
                            <img src="../../assets/images/Freshwork/Quick Approvals.png" alt="Quick Approvals">
                        </div>
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 col-md-6">
                    <div class="single-features-item">
                        <div class="icon">
                            <img src="../../assets/images/Freshwork/Configure Price Quote.png" alt="Configure Price Quote">
                            </div>                        
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 col-md-6">
                    <div class="single-features-item">
                        <div class="icon">
                            <img src="../../assets/images/Freshwork/Subscription.png" alt="Subscription">
                        </div>
                        <h3><a href="https://www.dealdox.io/pricing">Pricing</a></h3>
