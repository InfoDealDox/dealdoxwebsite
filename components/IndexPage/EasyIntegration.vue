                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="features-content">
                            <ul class="features-list">
                                <h2>Generate <span class="sub-title"> <a href="https://www.dealdox.io/quoting-software"> Automated</a>
                                    </span> <span class="sub-title"> <a href="https://www.dealdox.io/quoting-software"> Quotes</a>
                                    </span> in a few Seconds! Save Time and Close More
                                    Deals</h2>
                                <li>
                                    <div class="icon">
