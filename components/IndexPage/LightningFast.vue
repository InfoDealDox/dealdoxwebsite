          ...
          <div class="col-lg-6 col-md-12">
            <div class="features-content">
              <ul class="features-list">
                <h2>
                  Lightning-Fast <br /><span class="sub-title"
                    ><a href="https://www.dealdox.io/approval-software"
                      >Quote Approvals</a
                    ></span
                  >
                </h2>
                <li>
                  ...
                  <p class="with-top-border">
                    Enables businesses to shorten the sales cycles
                  </p>
                </li>
                <li>
                  <div class="icon">
                  ...
                  <p class="with-top-border">
                    Streamlines approval workflow, eliminates bottlenecks
                  </p>
                </li>
                <li>
                  <div class="icon">
                  ...
                  <p>Real-Time visibility in Approval workflow</p>
                </li>
              </ul>

              <div class="btn-box">
                <NuxtLink to="/approval-software" class="default-btn"
                  >Know more</NuxtLink
                >
              </div>
            </div>
