<template>
  <div>
          ...
          <div class="col-lg-2 col-md-6 col-sm-6">
            <div class="single-footer-widget">
              ...
              <ul class="links-list">
                ...
                <li>
                  <NuxtLink to="/approval-software" class="footer-content">Workflow Approvals</NuxtLink>
                </li>
                <li>
          ...
          <div class="col-lg-2 col-md-3 col-sm-6">
            <div class="single-footer-widget">
              ...
              <ul class="links-list">
                ...
                <li>
                  <NuxtLink to="/microsoft-dynamics-365-cpq-integration" class="footer-content">Microsoft Dynamics
                  </NuxtLink>
                </li>
                <li>
                  <NuxtLink to="/freshworks-cpq-integration" class="footer-content">Freshworks</NuxtLink>
                </li>
                <li>
    ...
    <div class="feature-data">
      <div class="">
        <FeatureToggle :features="featuresSet1" showText="Product" />

        <FeatureToggle :features="featuresSet2" showText="Solutions" />
        <FeatureToggle :features="featuresSet3" showText="Resources" />
        <FeatureToggle :features="featuresSet4" showText="Company" />
...
<script>
import FeatureToggle from '../components/Footer/FeatureToggle.vue';
