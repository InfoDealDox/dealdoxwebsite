    ...
    <div>
        ...
        <div class="odoo-container">
            ...
            <div class="table-alternative-containersss">
                <Tablealternative :comparisionDatas="comparisionData" company1="Zoho" company2="DealDox"
                    companyName1="Zoho" companyName2="Dealdox" />
            </div>
        </div>
...
export default {
    ...
    methods: {
        async getComparisonData() {
            try {
                const response = await axios.get("https://cms.dealdox.io/api/zoho-compare?populate=*");
                console.log("Connectwise Data:", response.data.data.attributes.ZohoComare);
                this.comparisionData = response.data.data.attributes.ZohoComare;
            } catch (error) {
