...
export default {
    ...
    created: async function () {
        ...
        const reaponse = await axios.get(`http://cms.dealdox.io/api/blogs?filters[slug][$eq]=${slug}&populate[image][populate][0]=image&populate[blog_author][populate][0]=profile_picture`, { params: { slug } })
