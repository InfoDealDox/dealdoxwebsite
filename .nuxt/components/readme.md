...
- `<Ebook>` | `<ebook>` (components/ebook/Ebook.vue)
- `<EbookDetails>` | `<ebook-details>` (components/ebook/EbookDetails.vue)
...
- `<GlossaryDetails>` | `<glossary-details>` (components/glossary/GlossaryDetails.vue)
- `<GlossaryPage>` | `<glossary-page>` (components/glossary/GlossaryPage.vue)
- `<GlossaryPageTitle>` | `<glossary-page-title>` (components/glossary/PageTitle.vue)
